...
**Frontend:** React, Vue, JavaScript, TypeScript, TailwindCSS  
**Backend:** Node.js, Express, REST APIs  
**Web3:** Solidity, Hardhat, Foundry  
**Tools & Platforms:** Git, Supabase, Vercel, GitHub Actions

## 🏆 Highlights

- 🥇 **1st Place (Statewide)** – BlockDAG Hackathon | *Technical Team Lead*
- 🥈 **2nd Place (100+ submissions)** – ETHSafari Hackathon | *Applications Developer*
- 🏅 **"Most Visionary Product"** – Curacel Hackathon | *Frontend Lead*
- 🥉 **Top 3 (40+ teams nationwide)** – National Hackathon | *Core Developer*

## 🚀 What I'm Building

- **Full-stack web applications** with React, Node.js, TypeScript & Next.js
- **AI-powered Web3 tools** like [Truce Wallet](https://github.com/Toyin05/Truce-Wallet) — helping users set spending limits and detect risky transactions
- **Project management & collaboration platforms** that streamline workflows and boost team productivity
- **Sales analytics dashboards** and data-driven applications
...
_"Building real-world solutions. One commit at a time."_
